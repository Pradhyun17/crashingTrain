...
function setup() {
  ...
  rope1 = new Chain(boggie1.body,boggie2.body)
  rope2 = new Chain(boggie2.body,boggie3.body)
  rope3 = new Chain(boggie3.body,boggie4.body)
  rope4 = new Chain(boggie4.body,boggie5.body)
  rope5 = new Chain(boggie5.body,boggie6.body)
...
if(boggie6.body.position.x>1100){
  crashSound.play();
}
  }
